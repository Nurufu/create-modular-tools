...
public final class AllPonderScenes {
    ...
    public static void moldSetup(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.overlay().showControls(util.vector().topOf(mold), Pointing.DOWN, 40).rightClick().withItem(sand);
        scene.idle(7);
        scene.overlay().showText(40)
		...
		scene.overlay().showControls(util.vector().topOf(mold), Pointing.DOWN, 40).rightClick();
        scene.idle(7);
        scene.overlay().showText(40)
		...
		scene.overlay().showControls(util.vector().topOf(mold), Pointing.DOWN, 40).rightClick().withItem(pickaxe);
        scene.idle(7);
        scene.overlay().showText(40)
    ...
    public static void moldUsing(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showControls(util.vector().topOf(mold), Pointing.DOWN, 40).rightClick().withItem(grip);
        scene.idle(7);
        scene.overlay().showText(40)
        ...
        scene.overlay().showControls(util.vector().topOf(mold), Pointing.DOWN, 10).rightClick().withItem(new ItemStack(AllItems.ZINC_TOOL_HANDLE));
        scene.idle(5);
		...
		scene.overlay().showControls(util.vector().topOf(mold), Pointing.DOWN, 40).leftClick();
        scene.idle(7);
        scene.overlay().showText(40)
        ...
        scene.idle(20);
        scene.world().createItemOnBelt(mold, Direction.NORTH, inputMoldStack);
        scene.idle(20);
